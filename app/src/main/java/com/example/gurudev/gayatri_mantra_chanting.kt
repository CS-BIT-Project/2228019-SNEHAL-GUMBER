...
class gayatri_mantra_chanting : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_gayatri_mantra_chanting, container, false)
    ...
    private fun initializeMediaPlayer() {
        mediaPlayer = MediaPlayer.create(requireContext(), R.raw.gayatri_mantra)
